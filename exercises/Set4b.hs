...
maxHelper a b = if a < b then b else a
...
largestHelper x [] = [x]
largestHelper x l = let e = head l in if x > e then [x] else if x == e then x : l else l
