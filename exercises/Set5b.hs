...
isOrdered (Node v l r) = isOrdered l && isOrdered r && allValues (< v) l && allValues (> v) r
...
walk (StepL : ss) (Node _ l r) = walk ss l
walk (StepR : ss) (Node _ l r) = walk ss r
